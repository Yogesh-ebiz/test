...
router
  .route('/:id/signatures')
  .get(authorize('update_member'), validate(memberValidation.getSignatures), memberCtrl.getSignatures)
  .post(authorize('update_member'), validate(memberValidation.addSignature), memberCtrl.addSignature)
  .put(authorize('update_member'), validate(memberValidation.updateSignature), memberCtrl.updateSignature);

router
  .route('/:id/signatures/:templateId')
  .get(authorize('update_member'), validate(memberValidation.getSignature), memberCtrl.getSignature)
  .put(authorize('update_member'), validate(memberValidation.updateSignature), memberCtrl.updateSignature)
  .delete(authorize('update_member'), validate(memberValidation.deleteSignature), memberCtrl.removeSignature)
  // .delete(authorize('view_user'), userController.deleteContact);
