  ...
  transform() {
    ...
    transformed.educations = _.reduce(this.education, function(res, edu){
      ...
      const education = {
        ...
        fromDate: edu.start_date,
        thruDate: edu.end_date
      }
      res.push(education);
      return res;
    }, []);
    ...
    transformed.primaryAddress = {
      ...
      locality: this.location_locality,
    ...
    transformed.hasPhone = this.phone_numbers.length? false:false;
...
module.exports = mongoose.model('People2', PeopleSchema);
